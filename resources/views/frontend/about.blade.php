    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100
                ...
                <div class="border-l-4 border-blue-600 pl-5">
                    ...
                    <p class="text-gray-600 leading-8 text-sm md:text-base">
                        Visi Badan Bank Tanah ditampilkan berdasarkan konten resmi
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100
            ...
            <div class="rounded-xl border border-dashed border-gray-300
                ...
                <div class="w-16 h-16 mx-auto rounded-full bg-white
                ...
                <p class="text-sm text-gray-500 mt-2 max-w-xl mx-auto">
                    Struktur organisasi ditampilkan berdasarkan data resmi
                    yang dikelola melalui CMS Badan Bank Tanah.
                </p>
