...
@section('title', 'Edit Halaman Pemanfaatan')

@section('content')
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-900">Edit Halaman Pemanfaatan</h1>
    <a href="{{ route('partnership') }}" class="text-sm text-gray-600 hover:text-[#006400]"><i class="fas fa-external-link-alt mr-1"></i> Lihat Halaman</a>
</div>

<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <!-- KOLOM KIRI (Form Utama) -->
    <div class="lg:col-span-2">
        <form action="{{ route('admin.halaman.update.partnership') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            @csrf
